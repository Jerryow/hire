...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //
        //return (Public.CookieHelper.Id != 0 && string.IsNullOrWhiteSpace(Public.CookieHelper.UserName) == false);
        //return (MrMatch.Common.SecurityHelper.xAdminUser != null);
        return (MrMatch.Admin.Handler.ActionFilters.CurrUserInfo.CurrUser!=null);
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "adamcms.com";
        LicenseKey = "G42XWAZMH4A2SH3V2FQZDZ5FMNEH3SWF";

        // The base URL used to reach files in CKFinder through the browser.
        BaseUrl = ConfigurationManager.AppSettings["UploadRootURL"] +"/UploadFile/";

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = ConfigurationManager.AppSettings["UploadRootPath"] ;
        ...
        PluginSettings.Add("ImageResize_smallThumb", "160x160" );
        PluginSettings.Add("ImageResize_mediumThumb", "300x300" );
        PluginSettings.Add("ImageResize_largeThumb", "400x400" );
