...
namespace MrMatch.Biz.Api.Base
{
    ...
    public class BasicAuthorize : AuthorizeAttribute
    {
        ...
        public override void OnAuthorization(System.Web.Http.Controllers.HttpActionContext actionContext)
        {
            ...
            //验证是否有特性
            //if (actionContext.ActionDescriptor.GetCustomAttributes<AAAttribute>(true).Count > 0)
            //{
            //    var atts = actionContext.ActionDescriptor.GetCustomAttributes<AAAttribute>(true)[0];
            //    //atts.Para(actionContext);
        ...
        private bool ValidateTicketNew(string encryptTicket)
        {
            try
            {
                ...
                redisToken = Application.Cache.GetCacheHelper.GetBizToken(user.PKID.ToString(), client);
