var vm = new Vue({
    ...
    data: {
        ...
        toolTips: {
            ...
            long: "请详尽介绍您的公司，建立雇主品牌，有利于求职者接受您的邀请哦！最多4000个汉字." + "公司介绍包括但不仅限于公司概况（股东结构、公司历史、主要产品或服务、雇员数目、年销售额），业务范围（主要市场& 新兴市场）、公司总部位置及分支布局、公司文化（使命、愿景、价值观）、公司主要客户介绍、公司所在行业上下游合作方、公司所获荣誉，及企业所作的社会贡献等."
        },
        form: {
            Website: "",
            ShortName: "",
        ...
        validate: {
            ...
            CellPhone: {
                isPass: false,
                rules: [{ message: '企业联系人手机号格式有误', rule: ChkUtil.isMobile }],
                message: '企业联系人手机号不能为空'
            },
            Email: {
                isPass: false,
                rules: [{ message: '企业联系人手机号格式有误', rule: ChkUtil.isEmail }],
                message: '企业联系人邮箱不能为空'
            }
        },
        confirmModalText: '',
    ...
    methods: {
        ...
        getBasicInfo: function () {
            axiosGet(api.account + "GetCompanyInfo").then(res => {
        ...
        submitForm: function (form, sta) {
            ...
            axiosPost(api.account + "UpdateCompany", this.form).then(res => {
