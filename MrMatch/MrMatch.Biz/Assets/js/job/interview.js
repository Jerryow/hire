var vm = new Vue({
    ...
    data: {
        ...
        cities: '',
        salaryList: [{ value: '0', selected: false }, { value: '120', selected: false }, { value: '150', selected: false }, { value: '200', selected: false }, { value: '250', selected: false }, { value: '300', selected: false }, { value: '400', selected: false }, { value: '500', selected: false }, { value: '800', selected: false }, { value: '1000', selected: false }, { value: '1200', selected: false }, { value: '1500', selected: false }, { value: '2000', selected: false }],
        salary: null,
        salaryMax: null,
        salaryMin: null,
        props: { multiple: true },
        ...
        jobOptions: [{
            ...
            children: [{
                value: 3, label: '会计',
                children: [{ value: 10, label: '初级会计' }, { value: 11, label: '财务总监' }, { value: 12, label: '初级会计' }, { value: 13, label: '财务总监' }, { value: 15, label: '财务总监' }]
            }, { value: 4, label: '黄埔' }, { value: 5, label: '徐汇' }]
        }, { value: 4, label: '互联网' }, { value: 5, label: '轻工业' }],
        headerText: false,
        submitLoading: false,
    ...
    methods: {
        ...
        getInterviewCount: function () {
            axiosGet(api.interview + "GetInterviewCount").then(res => {
        ...
        getFunctionForCascader: function () {
            ...
            axiosGet(api.candidate + "GetFunctionForCascader", this.form).then(res => {
        ...
        getAllDistrictList: function () {
            this.submitLoading = true;
            axiosGet(api.candidate + "GetAllDistrictList", this.form).then(res => {
                if (res.code == 1) {
        ...
        getProfileList: function () {
            this.submitLoading = true;
            axiosGet(api.interview + "GetJobInterviewList", this.form).then(res => {
                console.log(res);
        ...
        getSearchLogList: function () {
            axiosGet(api.candidate + "GetSearchLogList", this.form).then(res => {
                if (res.code == 1) {
