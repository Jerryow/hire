Vue.component('editCompanyDialog', {
    ...
    data: function () {
        return {
            rules: {
                ...
                ShortName: [{ required: true, message: '请输入对外显示名称', trigger: 'change' }],
                City: [{ required: false, message: '请输入所在城市', trigger: 'change' }],
                CompnayType: [{ required: false, message: '请选择企业类型', trigger: 'change' }],
                EmployeeNum: [{ required: false, message: '请选择企业规模', trigger: 'change' }],
                Summary: [{ required: false, message: '请输入公司简介', trigger: 'change' }],
                Introduce: [{ required: false, message: '请补充说明', trigger: 'change' }]
            },
            form: {
                PKID: 0,
                CompanyName: '',
            ...
            comType: [{ ID: 11, Name: "国有企业" }, { ID: 12, Name: "集体企业" }, { ID: 13, Name: "股份合作企业" }, { ID: 14, Name: "联营企业" }, { ID: 15, Name: "有限责任公司" }, { ID: 16, Name: "股份有限公司" }, { ID: 17, Name: "私营企业" }, { ID: 18, Name: "港澳台商投资企业" }, { ID: 19, Name: "外商投资企业" }],
            employeeNum: [{ ID: 1, Name: "少于15人" }, { ID: 2, Name: "15-50人" }, { ID: 3, Name: " 50-150人" }, { ID: 4, Name: "150-500人" }, { ID: 5, Name: " 500-1000人" }, { ID: 6, Name: "1000-5000人" }, { ID: 7, Name: "5000-10000人" }, { ID: 8, Name: "10000人以上" }]
        };
    },
    template: `
    ...
    methods: {
        ...
        GetJobCompany() {
            axiosGet(api.delivery + "GetAgentCompanyByID?PKID=" + this.form.PKID).then(res => {
                if (res.code == 1) {
                    this.form = res.data;
        ...
        submitForm(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    // true
                    axiosPost(api.delivery + "SaveAgentCompany", this.form).then(res => {
