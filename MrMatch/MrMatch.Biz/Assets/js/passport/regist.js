var vm = new Vue({
    ...
    methods: {
        ...
        getImage: function () {
            ...
            if (isPhone && !this.loading.sendLoading) {
                axios.get(api.passport + "GetPicInfo", { params: { phone: this.registArgs.CellPhone } }).then(res => {
                    if (res.data.code == 1) {
        ...
        getVerifyCode(moveEnd_X) {
            ...
            if (isPhone && !this.loading.sendLoading) {
                ...
                axios.post(api.passport + "SendVerifyCode", { PhoneNumber: this.registArgs.CellPhone, UserOffsetX: moveEnd_X, UserSign: this.imgVerOption.Sign }).then(res => {
                    res = res.data;
        ...
        getEmailVerifyCode() {
            ...
            if (isEmail && !this.loading.sendEmailLoading) {
                ...
                axios.get(api.passport + "SendEmailVerifyCode", { params: { accountEmail: this.registArgs.Email } }).then(res => {
