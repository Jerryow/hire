...
window.bus = new Vue({
    ...
    methods: {
        // 获取基础信息
        getBasicInfo: function getBasicInfo(that, fun) {
            ...
            if (userinfo !== '') {
                ...
                axiosGet(api.profile + "GetUserInfo").then(function (res) {
                    console.log(res);
        ...
        // 获取所有简历信息
        getAllProfile: function getAllProfile(that, fun) {
        ...
        lockMessage: function lockMessage(that, type) {
            if (type) {
