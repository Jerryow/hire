...
namespace MrMatch.CandidateClient.Handler.ActionFilters
{
    public class CurrID
    {
        public static long PKID
        {
            get
            {
                try
                {
                    var cookie = CookiesManager.GetCookie("candidate_user");
        ...
        public static string LoginName
        {
            get
            {
                try
                {
                    var cookie = Handler.CookiesManager.GetCookie("candidate_user");
                    if (string.IsNullOrEmpty(cookie))
                    {
                        return "";
                    }
        ...
        public static string Tickets
        {
            get
            {
                var ticket = Handler.CookiesManager.GetCookie("candidate_user");
                return ticket;
            }
        }
    }
